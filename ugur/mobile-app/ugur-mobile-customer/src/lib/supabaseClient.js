...
// console.log('Supabase client initialized with URL:', SUPABASE_URL ? 'Loaded' : 'NOT LOADED');
...
// Alternatif olarak, anahtarlar yoksa null bir client döndürülebilir ve uygulama içinde kontrol edilebilir.
/*
...
if (!supabase) {
  console.error('Supabase client başlatılamadı. Lütfen .env dosyasındaki SUPABASE_URL ve SUPABASE_ANON_KEY değerlerini kontrol edin.');
}
*/
